...
Syntax file and other settings for [Lyra](http://lyralang.org). 
...
```
git clone https://github.com/lyralang/lyra-vim.git
                //~/.vim/pack/typescript/start/lyra-vim
```
...
automatically enabled anytime you edit a `.ly` or `.lyr` or `.lyra` file.
